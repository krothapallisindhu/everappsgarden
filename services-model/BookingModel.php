...
class BookingModel {
    ...
    public function insertBookingDetails($cab_id, $user_id,$from_address, $to_address,$passenger_number,$laugage,$description,$booking_date) {
        ...
        $sql = sprintf("insert into tb_booking(cab_id,user_id,from_address,to_address,passenger_number,laugage,description,booking_date) values('$cab_id', '$user_id','$from_address', '$to_address','$passenger_number','$laugage','$description','$booking_date')");
