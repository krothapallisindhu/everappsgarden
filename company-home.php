...
if (isset($_POST['submitted'])) {
    if ($wsbookingmodel->updateBookingRecord()) {  
        $fgmembersite->RedirectToURL("booking_update.php");
    }
}
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US">
    ...
    <script src="javascripts/updatebooking.js"></script>
    <!-- Header Section --> 
        ...
        <div class="row" style="padding-left: 15px;" >
            ...
            <div class="ten columns" >  
                ...
                <div class="ten columns" style="width:100%;height:auto;padding-left: 0px;padding-right: 0px;">  
                    ...
                    <?php
                    $myCollection = $wsbookingmodel->getBookingObjectsArray('web');
                    ...
                    for ($i = 0; $i < $myCollection->getLenth(); $i++) {
                        ...
                        <div class="ten columns" style="height:auto;border-left: 1px solid #2BA6CB;padding-top: 10px;padding-bottom: 10px;border-right: 1px solid #2BA6CB;border-bottom: 1px solid #2BA6CB;width:100%;height:auto;padding-left: 0px;padding-right: 0px;">
                            ...
                            <form id='addGroupRecord' action='<?php echo $wscommonmodel->GetSelfScript(); ?>' method='post' accept-charset='UTF-8'> 
                                <select style='width:65px' name='driver' id='driver' onchange="getBooking()">
                                    <option>Select</option>
                                    <?php
                                    $driverCollection = $fgmembersite->getDriverDetails('web');
                                    //Getting data from dataobjects using php code
                                    for ($k = 0; $k < $driverCollection->getLenth(); $k++) {
                                        $driverDetails = $driverCollection->getObject($k);
                                        ?>
                                        <option id="select" value=<?php echo $driverDetails->getUserId(); ?>><?php echo $driverDetails->getUserName() ?></option>
                                        <?php
                            ...
                            <div class="one columns" style="text-align: center;font-size: 12px;text-align: center;width:12%;padding-left: 0px;padding-right: 1px;">
                                    ...
                                    <div style='width: 50%;text-align: center;float: left'>
                                        ...
                                        <input type='text' name='booking_id' id='booking_id' value="<?php echo $bookingDetails->getBookingId(); ?>" maxlength="50" /><br/>                       
                                        <input type='text' name='driver_id' id='driver_id' /><br>
                                    </div>   
                                    <div style="width: 50%;float:right"> <input type='submit' name='Submit' value='Submit' /></div>
